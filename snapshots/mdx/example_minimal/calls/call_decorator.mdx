...
## <ApiType type="Module" path="calls/call_decorator" symbolName="example-py-minimal" /> example-py-minimal

A minimal example package for testing api2mdx.

## <ApiType type="Alias" path="calls/call_decorator" symbolName="Call" /> Call
...
## <ApiType type="Alias" path="calls/call_decorator" symbolName="BaseCall" /> BaseCall
...
## <ApiType type="Alias" path="calls/call_decorator" symbolName="call_decorator" /> call_decorator
