...
## <ApiType type="Module" path="calls/BaseCall" symbolName="example-py-minimal" /> example-py-minimal

A minimal example package for testing api2mdx.

## <ApiType type="Alias" path="calls/BaseCall" symbolName="Call" /> Call
...
## <ApiType type="Alias" path="calls/BaseCall" symbolName="BaseCall" /> BaseCall
...
## <ApiType type="Alias" path="calls/BaseCall" symbolName="call_decorator" /> call_decorator
