...
## <ApiType type="Module" path="calls/Call" symbolName="example-py-minimal" /> example-py-minimal
...
## <ApiType type="Alias" path="calls/Call" symbolName="BaseCall" /> BaseCall
...
## <ApiType type="Alias" path="calls/Call" symbolName="call_decorator" /> call_decorator
