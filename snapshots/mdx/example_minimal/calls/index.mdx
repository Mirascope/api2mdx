...
## <ApiType type="Module" path="calls/index" symbolName="example-py-minimal" /> example-py-minimal
...
## <ApiType type="Alias" path="calls/index" symbolName="BaseCall" /> BaseCall
...
## <ApiType type="Alias" path="calls/index" symbolName="call_decorator" /> call_decorator
