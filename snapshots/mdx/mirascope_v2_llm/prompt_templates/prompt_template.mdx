...
## <ApiType type="Alias" path="prompt_templates/prompt_template" symbolName="prompt_template" /> prompt_template
...
<ReturnTable
  ...
  "type_info": {
    ...
    "description": null,
    "kind": "simple",
    "doc_url": "/docs/mirascope/api/prompt_templates/decorator/PromptTemplateDecorator#prompttemplatedecorator"
  },
...
**Alias to:** `mirascope_v2_llm.prompt_templates.decorator.prompt_template`
