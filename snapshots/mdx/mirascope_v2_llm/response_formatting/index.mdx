...
## <ApiType type="Module" path="response_formatting/index" symbolName="from_call_args" /> from_call_args

The `FromCallArgs` class annotation for marking a field as a call argument.

## <ApiType type="Module" path="response_formatting/index" symbolName="decorator" /> decorator
