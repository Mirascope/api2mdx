...
## <ApiType type="Alias" path="models/model" symbolName="model" /> model
...
<ParametersTable
  ...
  },
  {
    ...
    "default": "{}",
    "description": "Optional parameters for the model (temperature, max_tokens, etc.)."
  }
]}
/>
...
**Alias to:** `mirascope_v2_llm.models.context.model`
