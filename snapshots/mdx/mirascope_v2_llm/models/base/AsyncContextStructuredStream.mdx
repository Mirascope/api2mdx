...
## <ApiType type="Alias" path="models/base/AsyncContextStructuredStream" symbolName="AsyncContextStructuredStream" /> AsyncContextStructuredStream
...
**Alias to:** `mirascope_v2_llm.responses.AsyncContextStructuredStream`
