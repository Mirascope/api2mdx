...
## <ApiType type="Alias" path="tools/context_tool/ContextToolDef" symbolName="ContextToolDef" /> ContextToolDef
...
**Alias to:** `mirascope_v2_llm.tools.context_tool_def.ContextToolDef`
