...
## <ApiType type="Alias" path="responses/base_response/DynamicConfig" symbolName="DynamicConfig" /> DynamicConfig
...
**Alias to:** `mirascope_v2_llm.prompt_templates.DynamicConfig`
